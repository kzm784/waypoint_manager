#include "waypoint_event_handler/speak_server.hpp"

using namespace std::chrono_literals;

waypoint_event::SpeakServer::SpeakServer(const rclcpp::NodeOptions &options) : Node("speak_server", options)
{
    // Create Server
...
void waypoint_event::SpeakServer::ServerApply()
{
...
void waypoint_event::SpeakServer::Callback(const std::shared_ptr<waypoint_event_msgs::srv::Command::Request> request, std::shared_ptr<waypoint_event_msgs::srv::Command::Response> response)
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(waypoint_event::SpeakServer)
