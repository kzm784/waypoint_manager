#include "waypoint_event_handler/wait_server.hpp"

using namespace std::chrono_literals;

waypoint_event::WaitServer::WaitServer(const rclcpp::NodeOptions &options) : Node("wait_server", options)
{
    // Create Server
...
void waypoint_event::WaitServer::ServerApply()
{
...
void waypoint_event::WaitServer::Callback(const std::shared_ptr<waypoint_event_msgs::srv::Command::Request> request, std::shared_ptr<waypoint_event_msgs::srv::Command::Response> response)
{
...
void waypoint_event::WaitServer::Delay(int sleep_time)
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(waypoint_event::WaitServer)