#include "waypoint_event_handler/map_change_server.hpp"

using namespace std::chrono_literals;

waypoint_event::MapChangeServer::MapChangeServer(const rclcpp::NodeOptions &options) : Node("map_change_server", options)
{
    // Create Server
...
void waypoint_event::MapChangeServer::ServerApply()
{
...
void waypoint_event::MapChangeServer::Callback(const std::shared_ptr<waypoint_event_msgs::srv::Command::Request> request, std::shared_ptr<waypoint_event_msgs::srv::Command::Response> response)
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(waypoint_event::MapChangeServer)
