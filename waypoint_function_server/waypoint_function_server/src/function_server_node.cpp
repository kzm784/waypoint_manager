...
waypoint_function::FunctionServerNode::FunctionServerNode(const std::string &server_name, const rclcpp::NodeOptions &options): Node(server_name, options) 
{
    ...
    update_sub_ = create_subscription<std_msgs::msg::Empty>("server_update", 1,
        bind(&FunctionServerNode::Update, this, std::placeholders::_1));

    response_pub_ = create_publisher<std_msgs::msg::String>("async_response", 10);
    
    // Client for Server Apply
    apply_client_ = create_client<waypoint_function_msgs::srv::Command>("server_apply");
    // Publisher for delete connection
    delete_apply_pub_ = create_publisher<std_msgs::msg::String>("delete_apply", 10);
}

void waypoint_function::FunctionServerNode::Update(const std_msgs::msg::Empty::SharedPtr){return;}
void waypoint_function::FunctionServerNode::FunctionCallback(const std::shared_ptr<waypoint_function_msgs::srv::Command::Request>,
      std::shared_ptr<waypoint_function_msgs::srv::Command::Response>){return;}
